<nav class="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-2 border-b border-gray-300  relative transition-all">
    <a href="${pageContext.request.contextPath}/">
        <img class="mr-2" src="${pageContext.request.contextPath}/assets/img/Amal.svg" alt="Logo">
    </a>
